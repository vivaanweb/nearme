...
ENV PUBLIC_SERVER_URL='https://nearme.quanlabs.com/parse'
...
ENV MASTER_KEY='ZJLfn1g95D'
ENV READ_ONLY_MASTER_KEY='o7oK5ZSL5e'
...
ENV MAILGUN_PUBLIC_LINK 'http://app.degula.in'
...
ENV GOOGLE_MAPS_API_KEY='AIzaSyA1noeMuoN6KIH9RE71KgFbOK2DHtuE0NQ'

ENV PUSH_ANDROID_SENDER_ID='662703699035'
ENV PUSH_ANDROID_API_KEY='AIzaSyCSpgOjlb119_DHj1SwdromweJaEqcX5sk'

ENV PUSH_IOS_BUNDLE_ID='com.nearme.degula'

ENV MAX_REQUEST_SIZE='20mb'
ENV DOKKU_LETSENCRYPT_EMAIL='vivaanweb@gmail.com'

# Generate an encrypted password for your parse dashboard user
# https://bcrypt-generator.com/
ENV PARSE_DASHBOARD_USER='admin'
ENV PARSE_DASHBOARD_PASS='$2y$12$iC4giXJ7JRExKE5O.LdbIeBbsKDxmbaRZWgTCpSHEseLv/HV1/aEK'

ENV PARSE_DASHBOARD_USER_READ_ONLY 'admin1'
ENV PARSE_DASHBOARD_PASS_READ_ONLY '$2y$12$iC4giXJ7JRExKE5O.LdbIeBbsKDxmbaRZWgTCpSHEseLv/HV1/aEK'