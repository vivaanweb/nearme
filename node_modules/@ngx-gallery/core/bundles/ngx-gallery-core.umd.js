(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/animations'), require('@angular/platform-browser'), require('@angular/common'), require('@angular/common/http'), require('rxjs'), require('rxjs/operators'), require('@angular/core')) :
    typeof define === 'function' && define.amd ? define('@ngx-gallery/core', ['exports', '@angular/animations', '@angular/platform-browser', '@angular/common', '@angular/common/http', 'rxjs', 'rxjs/operators', '@angular/core'], factory) :
    (factory((global['ngx-gallery'] = global['ngx-gallery'] || {}, global['ngx-gallery'].core = {}),global.ng.animations,global.ng.platformBrowser,global.ng.common,global.ng.common.http,global.rxjs,global.rxjs.operators,global.ng.core));
}(this, (function (exports,animations,platformBrowser,common,http,rxjs,operators,i0) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var LazyImage = /** @class */ (function () {
        function LazyImage(http$$1, document) {
            var _this = this;
            this.http = http$$1;
