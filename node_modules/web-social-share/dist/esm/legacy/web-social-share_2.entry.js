...
var WebSocialShare = /** @class */ (function () {
    ...
    WebSocialShare.prototype.renderTargets = function () {
        ...
        if (!this.share || !this.share.config) {
            ...
            return (this.share.config.map(function (config) { return h("web-social-share-target", { displayNames: _this.share.displayNames, share: config }); }));
        }
    };
...
var WebSocialShareTarget = /** @class */ (function () {
    ...
    WebSocialShareTarget.prototype.renderButton = function () {
        ...
        if (this.share.facebook) {
            return (h("button", { onClick: function ($event) { return _this.handleFacebookShare($event); }, class: 'web-social-share-button web-social-share-button-facebook' }, this.renderIcon(), this.renderName(this.share.facebook, 'Facebook')));
        }
        else if (this.share.twitter) {
            return (h("button", { onClick: function ($event) { return _this.handleTwitterShare($event); }, class: 'web-social-share-button web-social-share-button-twitter' }, this.renderIcon(), this.renderName(this.share.twitter, 'Twitter')));
        }
        else if (this.share.email) {
            return (h("button", { onClick: function ($event) { return _this.handleEmailShare($event); }, class: 'web-social-share-button web-social-share-button-email' }, this.renderIcon(), this.renderName(this.share.email, 'Email')));
        }
        else if (this.share.linkedin) {
            return (h("button", { onClick: function ($event) { return _this.handleLinkedinShare($event); }, class: 'web-social-share-button web-social-share-button-linkedin' }, this.renderIcon(), this.renderName(this.share.linkedin, 'Linkedin')));
        }
        else if (this.share.pinterest) {
            return (h("button", { onClick: function ($event) { return _this.handlePinterestShare($event); }, class: 'web-social-share-button web-social-share-button-pinterest' }, this.renderIcon(), this.renderName(this.share.pinterest, 'Pinterest')));
        }
        else if (this.share.reddit) {
            return (h("button", { onClick: function ($event) { return _this.handleRedditShare($event); }, class: 'web-social-share-button web-social-share-button-reddit' }, this.renderIcon(), this.renderName(this.share.reddit, 'Reddit')));
        }
        else if (this.share.whatsapp) {
            return (h("button", { onClick: function ($event) { return _this.handleWhatsappShare($event); }, class: 'web-social-share-button web-social-share-button-whatsapp' }, this.renderIcon(), this.renderName(this.share.whatsapp, 'WhatsApp')));
        }
