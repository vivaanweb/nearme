...
class WebSocialShare {
    ...
    renderTargets() {
        if (!this.share || !this.share.config) {
            ...
            return (this.share.config.map((config) => __chunk_1.h("web-social-share-target", { displayNames: this.share.displayNames, share: config })));
        }
    }
...
class WebSocialShareTarget {
    constructor(hostRef) {
        ...
        this.socialShareLoaded = __chunk_1.createEvent(this, "socialShareLoaded", 7);
    }
    ...
    renderButton() {
        if (this.share.facebook) {
            return (__chunk_1.h("button", { onClick: ($event) => this.handleFacebookShare($event), class: 'web-social-share-button web-social-share-button-facebook' }, this.renderIcon(), this.renderName(this.share.facebook, 'Facebook')));
        }
        else if (this.share.twitter) {
            return (__chunk_1.h("button", { onClick: ($event) => this.handleTwitterShare($event), class: 'web-social-share-button web-social-share-button-twitter' }, this.renderIcon(), this.renderName(this.share.twitter, 'Twitter')));
        }
        else if (this.share.email) {
            return (__chunk_1.h("button", { onClick: ($event) => this.handleEmailShare($event), class: 'web-social-share-button web-social-share-button-email' }, this.renderIcon(), this.renderName(this.share.email, 'Email')));
        }
        else if (this.share.linkedin) {
            return (__chunk_1.h("button", { onClick: ($event) => this.handleLinkedinShare($event), class: 'web-social-share-button web-social-share-button-linkedin' }, this.renderIcon(), this.renderName(this.share.linkedin, 'Linkedin')));
        }
        else if (this.share.pinterest) {
            return (__chunk_1.h("button", { onClick: ($event) => this.handlePinterestShare($event), class: 'web-social-share-button web-social-share-button-pinterest' }, this.renderIcon(), this.renderName(this.share.pinterest, 'Pinterest')));
        }
        else if (this.share.reddit) {
            return (__chunk_1.h("button", { onClick: ($event) => this.handleRedditShare($event), class: 'web-social-share-button web-social-share-button-reddit' }, this.renderIcon(), this.renderName(this.share.reddit, 'Reddit')));
        }
        else if (this.share.whatsapp) {
            return (__chunk_1.h("button", { onClick: ($event) => this.handleWhatsappShare($event), class: 'web-social-share-button web-social-share-button-whatsapp' }, this.renderIcon(), this.renderName(this.share.whatsapp, 'WhatsApp')));
        }
        else if (this.share.copy) {
